...
from es_service.es_constant.constants import PAPER_DOCUMENT_INDEX, PAPER_MAPPING, PAPER_MAPPING_V2
from es_service.es_helpers.es_connection import elasticsearch_connection
if __name__ == "__main__":
    download_data(0)
    #create_index(es=elasticsearch_connection, index=PAPER_DOCUMENT_INDEX, mapping=PAPER_MAPPING_V2)
    #index_papers()
